...
#define SET_BIT(REG,sgu16_SOS_index) (REG|=(1<<sgu16_SOS_index))
#define CLR_BIT(REG,sgu16_SOS_index) (REG&=(~(1<<sgu16_SOS_index)))
#define GET_BIT(REG,sgu16_SOS_index) ((REG>>sgu16_SOS_index)&0x01)
#define TOGGLE_BIT(REG,sgu16_SOS_index) (REG^=(1<<sgu16_SOS_index))
#define TOGGLE_PORT(REG) (REG^=0xff)
#define BIT_IS_SET(REG,sgu16_SOS_index) (REG&(1<<sgu16_SOS_index))
#define BIT_IS_CLR(REG,sgu16_SOS_index) (!(REG&(1<<sgu16_SOS_index)))
